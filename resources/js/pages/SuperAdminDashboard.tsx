        ...
        >
            ...
            <div className="grid gap-4 md:grid-cols-2">
                ...
                <Card className="relative overflow-hidden bg-gradient-to-r from-blue-50 to-blue-100 border-blue-200">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium text-blue-700">{t('Total Users')}</CardTitle>
                        <Building2 className="h-8 w-8 text-blue-700 opacity-80" />
                    </CardHeader>
                    <CardContent>
                        <div className="text-2xl font-bold text-blue-700">{stats.total_users}</div>
                        <p className="text-xs text-blue-700 opacity-80 mt-1">{t('All users')}</p>
                    </CardContent>
                </Card>
            </div>
            ...
            <Card className="mt-6">
                ...
                <CardContent>
                    <LineChart
                        ...
                        showGrid={true}
                        lines={[
                            { dataKey: 'companies', color: '#3b82f6', name: 'Companies' }
                        ]}
                        xAxisKey="month"
                        showLegend={true}
                    />
